...
Public Class landingPageSignatory
    ...
    Private Sub landingPageSignatory_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If CurrentUser IsNot Nothing Then
            ...
            SignatoryInitials = GetInitials(CurrentUser.Name)
        Else
    ...
    Private Sub LoadSignatoryJobs()
        ...
        Try
            Using conn As New SQLiteConnection("Data Source=PersonnelDB.db;Version=3;")
                conn.Open()
                Dim query As String = "SELECT id, job_id, technician_initials, technician_name, signatory_initials, signatory_name, company_name, company_address, model, serial_number, status, date_created, calibration_date, parameters, manufacturer, description, calibration_type, specific_site, last_updated_by FROM calibration_jobs WHERE last_updated_by = @initials OR signatory_initials = @initials ORDER BY date_created DESC"
    ...
    Private Sub DisplayCurrentPage()
        ...
        filterAll.Location = New Point(10, 10)
        filterReview.Location = New Point(100, 10)
        filterRevision.Location = New Point(230, 10)
        filterApproved.Location = New Point(390, 10)
        ...
        ' === Update page label + navigation ===
        Dim totalPages As Integer = Math.Ceiling(filteredJobs.Count / jobsPerPage)
