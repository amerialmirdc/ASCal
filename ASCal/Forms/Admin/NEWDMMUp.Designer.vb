...
Partial Class NEWDMM
    ...
    Friend WithEvents descriptionNew As TextBox
    Friend WithEvents Label8 As Label
    Friend WithEvents modelNew As TextBox
    Friend WithEvents Label9 As Label
    Friend WithEvents CheckBox6 As CheckBox
    Friend WithEvents manufacturerNew As TextBox
    ...
    Friend WithEvents compMan As Button
    ...
    Friend WithEvents newSaveBtn As Button
